...
function $pyjs__class_instance(class_name, module_name) {
    ...
    var cls_fn = function(){
        ...
        if (typeof instance.__init__ == 'undefined' || typeof instance.__init__.__$pyjs_autogenerated__ != 'undefined') {
            return instance;
        }
        if (instance.__is_instance__ !== false) {
...
function $pyjs__class_function_checked__new__(cls) {
    ...
    return new cls.$__instancector__(cls);
}
